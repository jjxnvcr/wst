...
<html lang="en">
  <head>
    ...
    <title>Santiago's Profile</title>
  ...
  <body>
    ...
    <div class="container">
      <div class="user-content user-profile">
        <div class="avatar">
          <img src="../../../../asset/santiago.jpg" alt="User Avatar" />
        </div>

        <div class="user">
          <h1 class="name">John Ivan Santiago</h1>
          <div class="title">
            <h4>BSIT Student</h4>
          </div>
        </div>
        ...
        <ul class="socials">
          <li>
            <span class="facebook-qlink">
              <a href="https://www.facebook.com/santiagojaaa04">
          ...
          <li>
            <span class="instagram-qlink">
              <a href="https://www.instagram.com/jaaasantiago">
      ...
      <div class="user-content user-details">
        <div class="user-about-me">
          ...
          <span class="content">
            <p>
              I am a person that is loving and kind to my family and friends, as well as my classmates and teachers. I am determined and passionate in everything that I do. I love everything about music. I like to sing, listening to different songs and in my free time, I play the piano and ukulele.
            </p>
          </span>
        </div>
        ...
        <div class="user-skills">
          ...
          <ul class="skills-list">
            ...
            <li class="skill">
              <span>
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-adobe"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12.893 4.514l7.977 14a.993 .993 0 0 1 -.394 1.365a1.04 1.04 0 0 1 -.5 .127h-3.476l-4.5 -8l-2.5 4h1.5l2 4h-8.977c-.565 0 -1.023 -.45 -1.023 -1c0 -.171 .045 -.34 .13 -.49l7.977 -13.993a1.034 1.034 0 0 1 1.786 0z" /></svg>
              </span>

              <span class="skill-info">
                <h4>Editing Tools</h4>
                <span>
                  <p>Efficient in the use of editing tools such as Adobe Photoshop and Canva</p>
                </span>
              </span>
            </li>
          </ul>
