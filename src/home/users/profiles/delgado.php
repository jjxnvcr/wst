  ...
  <body>
    ...
    <div class="container">
      <div class="user-content user-profile">
        <div class="avatar">
          <img src="../../../../asset/delgado.jpg" alt="User Avatar" />
        </div>

        <div class="user">
          <h1 class="name">Ryan Micko Delgado</h1>
          <div class="title">
            <h4>BSIT Student</h4>
          </div>
        </div>
        ...
        <ul class="socials">
          <li>
            <span class="facebook-qlink">
              <a href="https://facebook.com/ryanmicko29">
          ...
          <li>
            <span class="instagram-qlink">
              <a href="https://instagram.com/ryko.oooo">
      ...
      <div class="user-content user-details">
        <div class="user-about-me">
          ...
          <span class="content">
            <p>
              I am an Information Technology student at Bulacan State University, passionate about technology, problem-solving, and innovation. I enjoy exploring various aspects of IT, including programming, cybersecurity, and web development. My goal is to continuously expand my knowledge and skills to stay updated with the ever-evolving tech industry. I thrive in collaborative environments and love tackling challenges that push me to think critically and creatively. With a strong foundation in IT and a drive for continuous learning, I aspire to contribute to the field by developing efficient and impactful solutions.
            </p>
          </span>
        </div>
